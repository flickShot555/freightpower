...
export default function Marketplace({ isPostHire, setIsPostHire, isAvailable, onAvailabilityToggle }) {
        ...
        <div className="card mp-gps-services-card">
          ...
          {locationLoading && (
            <div style={{ padding: '20px', textAlign: 'center' }}>
              ...
              <p style={{ marginTop: '10px', color: '#64748b' }}>Getting your location...</p>
            </div>
          )}
          ...
          {locationError && (
            <div style={{ 
              ...
              <p style={{ marginTop: '10px', color: '#dc2626' }}>{locationError}</p>
        ...
        <div className="card mp-nearby-providers-card">
          ...
          {locationLoading && (
            <div style={{ padding: '40px', textAlign: 'center' }}>
              <i className="fa-solid fa-spinner fa-spin" style={{ fontSize: '1.5rem', color: '#3b82f6' }}></i>
              <p style={{ marginTop: '10px', color: '#64748b' }}>Loading nearby services...</p>
            </div>
          )}
          ...
          {!locationLoading && locationError && (
            <div style={{ 
              ...
              <p style={{ marginTop: '15px', color: '#dc2626', fontWeight: '600' }}>
                Location Required
              </p>
          ...
          {!locationLoading && !locationError && nearbyServices.length > 0 && (
            <>
              ...
              {(showFavoritesOnly || Object.values(selectedFilters).some(v => v)) && (
                <div style={{
                  padding: '12px',
                  background: showFavoritesOnly ? '#fef2f2' : '#eff6ff',
                  borderRadius: '8px',
                  margin: '10px',
                  display: 'flex',
                  alignItems: 'center',
                    ...
                    <div className="mp-provider-actions">
                      ...
                      {service.latitude && service.longitude && (
                        <button 
                          ...
                          style={{ marginTop: '8px', width: '100%', background: '#fff', border: '1px solid #e2e8f0' }}
          ...
          {!locationLoading && !locationError && !showFavoritesOnly && nearbyServices.length === 0 && (
            <div style={{ padding: '40px', textAlign: 'center' }}>
              ...
              <div style={{ 
                ...
                <strong style={{ color: '#92400e' }}>🐛 Debug Info:</strong>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '800px', maxHeight: '80vh', overflowY: 'auto' }}>
            ...
            <div className="modal-body">
              {locationLoading && (
                <div style={{ padding: '40px', textAlign: 'center' }}>
                  <i className="fa-solid fa-spinner fa-spin" style={{ fontSize: '2rem', color: '#3b82f6' }}></i>
                  <p style={{ marginTop: '10px', color: '#64748b' }}>Loading services...</p>
                </div>
              )}
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                        <h3 style={{ margin: 0, color: '#1e293b' }}>{service.name}</h3>
                        {service.verified && (
                      ...
                      <p style={{ color: '#64748b', marginBottom: '10px', fontSize: '0.9375rem' }}>
                        {service.description}
                      </p>
                  ...
                  <div style={{ display: 'flex', gap: '10px', marginTop: '15px', flexWrap: 'wrap' }}>
                    ...
                    {service.website && (
                      <button 
                        ...
                        style={{ flex: 1, minWidth: '150px', background: '#fff', border: '1px solid #e2e8f0' }}
                      >
