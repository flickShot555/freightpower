...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // For now mirror previous behavior: navigate to verification with role state
    navigate('/verify', { state: { role } });
  };

  const signupLinkFor = (r) => {
    if (r === 'carrier') return '/carrier-signup';
    if (r === 'driver') return '/driver-signup';
    return '/shipper-signup';
  };
    ...
    <div className="carrier-signup-container carrier-login-page">
      <div className="carrier-signup-left">
        ...
        <div className="carrier-signup-form-bg">
          <h1 className="carrier-signup-title">Login</h1>
          <p className="carrier-signup-subtitle">Access your account</p>
          ...
          <form className="carrier-signup-form" onSubmit={handleSubmit}>
            ...
            <div className="carrier-signup-bottom-actions">
              ...
              <div className="carrier-signup-login-text">
                Don't have an account? <a href={signupLinkFor(role)}>Sign up</a>
              </div>
            </div>
          </form>
        </div>
        ...
        <div className="carrier-signup-info-bottom">
          ...
          <div className="carrier-signup-info-simple">
            ...
            <ul>
              ...
              <li>📨 Share your full profile & manage onboarding</li>
