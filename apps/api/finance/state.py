...
def can_transition(current: InvoiceStatus, new: InvoiceStatus) -> bool:
    allowed: dict[InvoiceStatus, set[InvoiceStatus]] = {
        ...
        InvoiceStatus.ISSUED: {InvoiceStatus.SENT, InvoiceStatus.VOID},
        InvoiceStatus.SENT: {InvoiceStatus.FACTORING_SUBMITTED, InvoiceStatus.OVERDUE, InvoiceStatus.PAID, InvoiceStatus.PARTIALLY_PAID},
